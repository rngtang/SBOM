...
class ReferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reference" do
    assert_difference("Reference.count") do
      post references_url, params: { reference: { age: @reference.age, description: @reference.description, name: @reference.name } }
    end
  ...
  test "should update reference" do
    patch reference_url(@reference), params: { reference: { age: @reference.age, description: @reference.description, name: @reference.name } }
